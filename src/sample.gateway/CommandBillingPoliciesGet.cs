...
public class CommandBillingPoliciesGet : BaseCommand<CommandBillingPoliciesGetOptions>
{
    public CommandBillingPoliciesGet(
        CommandBillingPoliciesGetOptions opts,
    ...
    {
        string gatewayUrl = _neptuneDiscovery.GetGatewayEndpoint();
        string gatewayResource = _neptuneDiscovery.GetTokenAudience();

        // API Endpoint
        string clusterurl = $"https://{gatewayUrl}/licensing/billingPolicies?api-version=2022-03-01-preview";
